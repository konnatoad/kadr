...
impl ThumbnailStrip {
    pub fn show(&self, ui: &mut Ui, entries: &[ThumbEntry<'_>], current: usize) -> StripResponse {
        ...
        ui.painter()
            .rect_filled(available_rect, theme::RADIUS, theme::SURFACE);
        ...
        ui.allocate_ui(Vec2::new(ui.available_width(), self.height), |ui| {
                ...
                .show(ui, |ui| {
                    ui.horizontal(|ui| {
                        ...
                        for (i, entry) in entries.iter().enumerate() {
                            ...
                            let (rect, resp) =
                                ui.allocate_exact_size(slot_size, Sense::click_and_drag());
